...
public class SystemUtil {
	...
	public static String get(final String key, String defaultValue) {
		...
		try {
			...
			log.info("Unable to retrieve a system property '"+key+"'; default values will be used.");
		}
	...
	public static Properties props() {
		...
		try {
			...
			log.info("Unable to retrieve a system propertys; default values will be used.");
		}
		return props;
	}
