package com.school.util.core.utils.excel.annotation;
...
public @interface Excel {
     ...
     */
    public int exportFieldWidth() default 18;

    /**
     * 导出时在excel中每个列的高度 单位为字符，一个汉字=2个字符
     */
    public int exportFieldHeight() default 15;

    /**
     * 若是sign为1,则需要在pojo中加入一个方法 convertGet字段名() 例如，字段sex ，需要加入 public String convertGet字段名() 返回值为string 若是sign为0,则不转换
     * 建议使用 @Transient 这个注解让hibernate忽略这个方法
     */
    ...
    /**
     * 方法描述: 数据字典表 作 者： yiming.zhang 日 期： 2014年5月11日-下午5:26:40
     * 
     * @return 返回类型： String
     */
    ...
    /**
     * 方法描述: 数据code 作 者： yiming.zhang 日 期： 2014年5月13日-下午9:37:16
     * 
     * @return 返回类型： String
     */
    ...
    /**
     * 方法描述: 数据Text 作 者： yiming.zhang 日 期： 2014年5月11日-下午5:29:05
     * 
     * @return 返回类型： String
     */
