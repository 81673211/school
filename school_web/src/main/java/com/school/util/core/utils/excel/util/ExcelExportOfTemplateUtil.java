...
public final class ExcelExportOfTemplateUtil {
    ...
    private static Workbook createSheetInUserModel2FileByTemplate(TemplateExportParams params, Class<?> pojoClass,
     ...
     * @param workbook
     */
    private static void addDataToSheet(TemplateExportParams params, Class<?> pojoClass, Collection<?> dataSet,
    ...
    private static void createStringCell(Row row, int index, String text, ExcelExportEntity entity, Workbook workbook) {
        ...
        case 1:
            RichTextString Rtext = workbook instanceof HSSFWorkbook ? new HSSFRichTextString(text)
                            : new XSSFRichTextString(text);
     ...
     * @throws Exception
     */
    private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row, int i, String field,
        ...
        row.createCell(i);
        ClientAnchor anchor = workbook instanceof HSSFWorkbook ? new HSSFClientAnchor(0, 0, 0, 0, (short) i,
                        row.getRowNum(), (short) (i + 1), row.getRowNum() + 1) : new XSSFClientAnchor(0, 0, 0, 0,
        ...
        if (entity.getExportImageType() == 1) {
            ...
            try {
                ...
                patriarch.createPicture(
                                ...
                                row.getSheet().getWorkbook()
                                                .addPicture(byteArrayOut.toByteArray(), Workbook.PICTURE_TYPE_JPEG));
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
            ...
            if (value != null) {
                patriarch.createPicture(anchor,
                                row.getSheet().getWorkbook().addPicture(value, Workbook.PICTURE_TYPE_JPEG));
            }
        }
     ...
     * @throws Exception
     */
    private static void getExcelField(String targetId, Field field, ExcelExportEntity excelEntity, Excel excel,
