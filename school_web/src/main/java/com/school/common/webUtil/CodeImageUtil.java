...
public class CodeImageUtil {
    ...
    public CodeImageUtil() {
        creatImage();
    }

    public CodeImageUtil(int width, int height) {
        this.width = width;
        this.height = height;
        creatImage();
    }

    public CodeImageUtil(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
 ...
 /*   //使用方法
    public void getCode3(HttpServletRequest req, HttpServletResponse response,HttpSession session) throws IOException{
        ...
        CodeImageUtil vCode = new CodeImageUtil(100,30,4,10);
