...
public class ConstantUrl {
	...
	public static final String EXPORT_DATA_URL = "exportDataUrl";
	 ...
	 */
	// 商品类型详情
	public static final String GOOD_TYPE_DETAIL_URL = "/good/goodType/detail.do";
	// 商品类型编辑
	public static final String GOOD_TYPE_EDIT_URL = "/good/goodType/edit.do";
	// 商品类型删除
	public static final String GOOD_TYPE_DEL_URL = "/good/goodType/del.do";
	
	/**
	 * 商品品牌
	 */
	// 商品品牌详情
	public static final String GOOD_BRAND_DETAIL_URL = "/good/goodBrand/detail.do";
	// 商品品牌编辑
	public static final String GOOD_BRAND_EDIT_URL = "/good/goodBrand/edit.do";
	// 商品品牌删除
	public static final String GOOD_BRAND_DEL_URL = "/good/goodBrand/del.do";
	
	/**
	 * 商品
	 */
	// 商品详情
	public static final String GOOD_INFO_DETAIL_URL = "/good/goodInfo/detail.do";
	// 商品编辑
	public static final String GOOD_INFO_EDIT_URL = "/good/goodInfo/edit.do";
	// 商品删除
	public static final String GOOD_INFO_DEL_URL = "/good/goodInfo/del.do";
	// 商品上下架
	public static final String GOOD_INFO_UP_AND_DOWN_URL = "/good/goodInfo/upAndDown.do";
	// 商品批量上架/下架
	public static final String GOOD_INFO_UP_AND_DOWN_ALL_URL = "/good/goodInfo/upAndDownAll.do";
	// 商品导出数据
	public static final String GOOD_INFO_EXPORT_DATA_URL = "/good/goodInfo/exportData.do";
	// 商品审核详情
	public static final String GOOD_INFO_AUTH_DETAIL_URL = "/good/goodAuth/detail.do";
	// 商品审核
