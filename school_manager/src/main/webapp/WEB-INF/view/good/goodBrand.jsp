...
<head>
    ...
    <script type="text/javascript">
      var vm_goodBrandManage=avalon.define({
          $id:'goodBrandManage',
          data:${listData},
...
<body :controller="goodBrandManage">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 商品管理 <span class="c-gray en">&gt;</span> 品牌列表 <a class="btn btn-success radius r"
    ...
    <div class="page-container">
        <div class="bk-gray pd-20 clearfix">
            <div class="tran-serch f-l">
                <input type="text" name="keywordSearch" id="" placeholder="商品品牌名称" style="width:200px" class="input-text" :duplex="@inputText">
		...
		<div class="pag-box withdarwal-pag" id="page">
			<form method="post" id="searchForm"
				action="${ctx}/good/goodBrand/list.do">
    ...
    <script type="text/javascript" src="${ctx}/static/model/good/goodBrand.js"></script>
</body>
</html>