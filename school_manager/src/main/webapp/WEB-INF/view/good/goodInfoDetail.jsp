...
<head>
    ...
    var vm_goodInfoDetail=avalon.define({
        $id:'goodInfoDetail',
        data:${goodInfo},
        isPostMap:${isPostMap},
...
<body :controller="goodInfoDetail">
...
<!--                 </div> -->
                ...
                <div class="row cl">
                    <div class="col-xs-3 text-r">状态：</div>
                    <div class="col-xs-9">
                        <p>{{@goodInfoStatusMap[@data.status]}}</p>
                    </div>
                </div>
                <div class="row cl" :if="@data.status == 5">
                    <div class="col-xs-3 text-r">审核不通过原因：</div>
                    <div class="col-xs-9">
    ...
    <script type="text/javascript" src="${ctx}/static/model/good/goodInfoDetail.js"></script>
</body>
</html>