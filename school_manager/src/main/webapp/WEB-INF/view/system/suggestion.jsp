...
<head>
    ...
    <script type="text/javascript">
      var vm_suggestionManage=avalon.define({
          $id:'suggestionManage',
          data:${listData},
...
<body :controller="suggestionManage">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 系统管理 <span class="c-gray en">&gt;</span> 意见列表 <a class="btn btn-success radius r"
...
<!--                     <option :for="(k,v) in @suggestionStatusMap" :attr="{value:k}">{{v}}</option>  -->
<!--                  </select> -->
<!--              </span> -->
<!--             </div> -->
            <div class="tran-serch f-l">
                <input type="text" name="keywordSearch" id="" placeholder="意见内容" style="width:200px" class="input-text" :duplex="@inputText">
                <button name="" id="" class="btn btn-primary radius" type="button" :click="@methods.query"><i class="Hui-iconfont"></i> 搜索</button>
            </div>
        </div>
        <div class="mt-20">
            <table class="table table-bsuggestion table-bsuggestioned table-hover table-bg table-sort" id="reviwtable">
                <thead>
                    <tr class="text-c">
                        <th width="25">编号</th>
                        <th width="50">客户名字</th>
    ...
    <script type="text/javascript" src="${ctx}/static/model/system/suggestion.js"></script>
</body>
</html>