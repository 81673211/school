requirejs(['requirejs.config'], function () {
  requirejs(["jquery", "Hui", "layer", 'dataTables', 'icheck', 'form', 'validation'],
    function (jquery, Hui, layer, dataTables, icheck, validation) {
      $(function () {
        ...
        var model = vm_expressReceiveManage;
        ...
        model.methods.add = function (editUrl) {
          layer.open({
            ...
            yes: function (index, layero) {
              ...
              iframeWin.vm_expressReceiveEdit.methods.validAndSubmit(function () {
                queryVal();
              });
            },
            btn2: function () {
